/* 
    This file is downloaded from http://www.voicerss.org/sdk/javascript.aspx
    Few things modified which can be seen below in comments
*/
const VoiceRSS = {
    speech(e) {
    ...
    _request(e) {
        ...
        t.onreadystatechange = function() {
            if (4 == t.readyState && 200 == t.status) {
                ...
                // Once we get the respnse text, we are feeding it to src of audio element and playing it.
