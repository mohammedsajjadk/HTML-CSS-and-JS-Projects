...
* We will have many .js files, but our main js file is ***index.js***. Inside index.js file we will import all our other .js files. We will convert the index.js file code to one single .js file (**bundle.js**) and that file will be injected into index.html.
